...
public class SearchRemoteDataSourceImpl implements SearchRemoteDataSource {
    ...
    public SearchRemoteDataSourceImpl(TheMealDBWebService theMealDBWebService,
                                      Mapper<MealDto, List<String>> mapper,
                                      Mapper<AreaDto, List<String>> areaMapper,
                                      Mapper<CategoryDto, List<String>> categoryMapper, Mapper<IngredientDto, List<MinIngredient>> ingredientMapper, SearchRemoteDataSourceListener searchRemoteDataSourceListener) {
