package com.soha.foodplanner.ui.profile;
...
public class ProfileFragment extends BaseFragment<ProfilePresenter> implements ProfilePresenterListener {
    ...
    protected void setListeners() {
        buttonLogout.setOnClickListener(v -> navController.navigate(ProfileFragmentDirections.actionProfileFragmentToConfirmDialogFragment(R.string.logout_confirm)));
    ...
    public void onLogoutSuccess() {
        ...
        navController.navigate(ProfileFragmentDirections.actionProfileFragmentToAuthNavGraph());
    }
